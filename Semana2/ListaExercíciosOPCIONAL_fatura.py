#Exercícios opcionais para treino
...
#o valor da fatura  e imprima (saída de dados) a mensagem com os dados
#recebidos, no mesmo formato da mensagem acima. Note que o programa imprime
#a saída em duas linhas diferentes. Note também que,
#como não é preciso realizar cálculos, o valor não precisa ser convertido
